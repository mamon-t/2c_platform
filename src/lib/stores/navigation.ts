...
export const allNavItems: NavItem[] = [
  ...
  { code: 'messages', label: 'Сообщения', icon: 'fa-solid fa-comments', path: '/messages' },
  { code: 'trade', label: 'Торговля', icon: 'fa-solid fa-cart-shopping', path: '/trade', requiredPermission: { subsystem: 'trade', action: 'read' } },
