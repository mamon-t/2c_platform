...
> ## ⚠️ Этот репозиторий архивирован
> 
> Данный репозиторий сохранён в состоянии "как есть" и больше не поддерживается. 
> Причина — пересмотр концепций платформы и переход к новой архитектуре.
> 
> **Дальнейшее развитие проекта продолжается в новом репозитории:**
> 👉 **[mamon-t/eventra_fc](https://github.com/mamon-t/eventra_fc.git)**
> 
> Здесь остаются актуальными:
> - Историческая документация по архитектуре v1 (метамодель, WASM-плагины, tx_exec)
> - Реализованные модули: Заявки, Склад, Торговля, Учёт
> - Примеры Plugin API и SDK для WASM-модулей
> 
> Если вы изучаете проект — начинайте с нового репозитория.
